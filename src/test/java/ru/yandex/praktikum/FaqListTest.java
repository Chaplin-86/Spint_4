...
import ru.yandex.praktikum.pages.FaqList;
...
public class FaqListTest {
    ...
    public FaqListTest(String itemId, String answerText) {
        this.itemId = itemId;
    ...
    public static void closeCookies() {
        new FaqList(driverRule.getDriver())
                .open();
    ...
    public void clickOnFaqItem() {
        new FaqList(driverRule.getDriver())
                ...
                .waitForAnswer(itemId, answerText);
